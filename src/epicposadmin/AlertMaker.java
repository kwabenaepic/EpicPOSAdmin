...
public class AlertMaker {
    ...
    public static void showTrayMessage(String title, String message) {
        try {
            ...
            BufferedImage image = ImageIO.read(AlertMaker.class.getResource("/images/cart.png"));
...
//        LibraryAssistantUtil.setStageIcon(stage);
        ...
        dialogPane.getStylesheets().add(AlertMaker.class.getResource("/css/Modena.css").toExternalForm());
